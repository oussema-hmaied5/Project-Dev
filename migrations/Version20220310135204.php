 ...
 */
final class Version20220310135204 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actualite CHANGE id id INT AUTO_INCREMENT NOT NULL, ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE actualite_categorie ADD PRIMARY KEY (actualite_id, categorie_id)');
        ...
        $this->addSql('CREATE INDEX IDX_EC878E9DA2843073 ON actualite_categorie (actualite_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE publication (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', views INT NOT NULL, titre VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE actualite MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE actualite DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE actualite CHANGE id id INT NOT NULL');
        ...
        $this->addSql('DROP INDEX IDX_EC878E9DA2843073 ON actualite_categorie');
        $this->addSql('DROP INDEX IDX_EC878E9DBCF5E72D ON actualite_categorie');
        $this->addSql('ALTER TABLE actualite_categorie DROP PRIMARY KEY');
