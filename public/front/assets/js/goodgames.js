...
function initNavbarDropEffect1() {
    ...
    // add front item for dropdowns
    $navbars.find('.dropdown').prepend('<li class="bropdown-front"><a href="#">' + self.options.templates.secondaryNavbarBackItem + '</a></li>');
    ...
    $navbars.on('click', '.bropdown-front > a', function (e) {
                ...
                _utility.$.ajax({
                    ...
                    success: function success(resp) {
                        ...
                        if (resp.result === 'success') {
                            ...
                            // Example errors - Note: You only get one front at a time even if you submit several that are bad.
...
function initPluginFlickity() {
    ...
    function addDefaultArrows($carousel) {
        (0, _utility.$)('<div class="nk-flickity-arrow nk-flickity-arrow-prev"><span class="ion-ios-arrow-front"></span></div>').on('click', function () {
